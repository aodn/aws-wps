...
public class AwsApiResponse {
    private boolean isBase64Encoded;
    private int statusCode;
    private Map<String, String> headers;
    private String body;

    AwsApiResponse(boolean isBase64Encoded, int statusCode, Map<String, String> headers, String body) {
    ...
    public static class ResponseBuilder {
        ...
        public AwsApiResponse build() {
            return new AwsApiResponse(isBase64Encoded, statusCode, headers, body);
        }
    }
}

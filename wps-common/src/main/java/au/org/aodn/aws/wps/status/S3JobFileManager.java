...
public class S3JobFileManager {
    ...
    public String read(String fileName) throws IOException {
        ...
        return new S3Utils().readObjectAsString(s3bucket, jobFileKey);
    }
    ...
    public void write(String content, String fileName, String contentType) throws IOException {
        ...
        s3Utils.uploadToTarget(content, s3bucket, jobFileKey, contentType);
    }
    ...
    public void upload(File file, String filename, String contentType) throws InterruptedException, IOException {
        ...
        s3Utils.uploadToTarget(file, s3bucket, jobFileKey, contentType);
    }
